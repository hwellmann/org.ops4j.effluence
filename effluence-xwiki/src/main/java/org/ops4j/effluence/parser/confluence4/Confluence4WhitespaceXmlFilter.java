 ...
 *
 */
public class Confluence4WhitespaceXmlFilter extends DefaultXMLFilter{
    ...
    public Confluence4WhitespaceXmlFilter()
    {

    }

    public Confluence4WhitespaceXmlFilter(XMLReader reader)
    {
        super(reader);
    }
